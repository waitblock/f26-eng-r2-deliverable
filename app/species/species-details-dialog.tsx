              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="" {...field} disabled={!isEditing} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input value={value ?? ""} placeholder="" {...rest} disabled={!isEditing} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={(value) => field.onChange(kingdoms.parse(value))} value={field.value} disabled={!isEditing}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="No kingdom selected" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        <SelectGroup>
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea value={value ?? ""} placeholder="" {...rest} disabled={!isEditing} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
